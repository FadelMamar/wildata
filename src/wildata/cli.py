...
from .config import ENV_FILE, ROOT, AugmentationConfig, ROIConfig, TilingConfig
...
from .pipeline import DataPipeline, FrameworkDataManager, Loader, PathManager
...
def create_roi_one_worker(args):
    ...
    try:
        ...
        from .cli import FrameworkDataManager, Loader, PathManager, ROIConfig
