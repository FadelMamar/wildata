...
from .filter_config import ClusteringFilterConfig, QualityFilterConfig
...
class ClusteringFilter(BaseFilter):
    ...
    def __init__(
        ...
        feature_extractor: Optional[Dinov2Extractor] = None,
        batch_size: int = 64,
        sampling_strategy: Optional[SamplingStrategy] = None,
    ):
        self.config = config
        self.feature_extractor = feature_extractor or Dinov2Extractor()
    ...
    def _compute_embeddings_in_batches(
        ...
        for i in range(0, len(image_paths), self.batch_size):
            ...
            batch_embeddings = self.feature_extractor.extract_features(batch_paths)  # type: ignore
