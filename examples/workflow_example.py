    ...
    if result['success']:
        ...
        for export_format in ['coco', 'yolo']:
            try:
                ...
                print(f"[SUCCESS] Exported to {export_format.upper()}: {export_result['output_path']}")
            except Exception as e:
...
def main():
    parser = argparse.ArgumentParser(description="WildTrain Data Pipeline Workflow Example")
